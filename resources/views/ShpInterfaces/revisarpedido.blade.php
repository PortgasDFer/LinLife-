         ...
         <div class="order_box">
          @if(count(Cart::getContent()))  
            ...
            <ul class="list list_2">
                ...
                <li><a href="#">Comisión PayPal <span>${{number_format($comision+4, 2)}}</span></a></li>
                <li><a href="#">Total <span>${{number_format(Cart::getTotal() +$comision+4, 2)}}</span></a></li>
            </ul>
            ...
            <div class="text-center">
              <form action="/insertarCarrito/{{$nuevofolio}}" method="POST">
                @csrf
                <input type="hidden" name="monto" value="{{Cart::getTotal()+$comision+4}}">
