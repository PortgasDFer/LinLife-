  ...
  <div class="container">
    <form action="/ventas" method="POST" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        ...
        <input type="input" class="form-control" id="folio" name="folio" value="{{$nuevofolio}}" readonly="">
      <div class="mb-3">
        <label class="form-label">Fecha</label>
        <input type="input" class="form-control" id="fecha" name="fecha" readonly="" value="{{$fechaactual}}">
      </div>
